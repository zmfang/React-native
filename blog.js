  ...
  render(
    ...
    var navigationView = (
      <View style={styles.container}>
        ...
        <Image 
           ...
           source={require('./image/qq_Bot.png')}
        />
        <Text
        ...
        <Image 
           ...
           source={require('./image/qq_qzone.png')}
        />
        <Text
        ...
        <Image 
           style={{width: 20, height: 20}}
           source={require('./image/qq_buy.png')}
        />
        <Text
   ...
   <TouchableNativeFeedback>
      <View style={styles.vertical_view}>
			  <Image source={require('./image/qq_qzone.png')} style={{alignSelf:'center',width:55,height:55}} />
    ...
    <View style={styles.rectangle_view}>
		  <View style={{flexDirection:'row',alignItems: 'center'}}>
			  <Image source={require('./image/qq_buy.png')} style={{alignSelf:'center',width:30,height:30}}/>
			  <Text style={styles.rectangle_text} >
				羽毛球
			  </Text>
		  </View>
		  <Image source={require('./image/fast_forward.png')} style={{alignSelf:'center',width:20,height:20}}/>
		 </View>
    ...
    <View style={styles.rectangle_view}>
     ...
     <View style={styles.button}>
        <TouchableNativeFeedback>
          ...
          <Image source={require('./image/qq_Bot.png')} style={{alignSelf:'center',width:28,height:28}}/>
